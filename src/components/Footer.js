      ...
      <footer className="footer mt-5">
              ...
              <ul className="footer-contact list-unstyled ">
                <li className="footer-call" ref={callRef}>
                  ...
                  <div
                    ...
                    aria-modal="true"
                  >
                    <div className="footer-call-modal-title">ℹ️ Call Hema Bakes?</div>
                ...
                <li className="footer-call" ref={mapRef}>
                  ...
                  <div
                    ...
                    aria-modal="true"
                  >
                    <div className="footer-call-modal-title">ℹ️ Open in Maps?</div>
                ...
                <li className="footer-call" ref={emailRef}>
                  ...
                  <div
                    ...
                    aria-modal="true"
                  >
                    <div className="footer-call-modal-title">ℹ️ Send an Email?</div>
        ...
        <div className="whatsapp-fab-wrap" ref={waRef}>
          ...
          <div className={`footer-call-modal wa-modal ${showWaConfirm ? "is-open" : ""}`} role="dialog" aria-modal="true">
            <div className="footer-call-modal-title">WhatsApp Hema Bakes?</div>
